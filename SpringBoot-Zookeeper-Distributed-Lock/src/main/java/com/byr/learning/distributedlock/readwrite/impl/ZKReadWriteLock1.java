package com.byr.learning.distributedlock.readwrite.impl;

import com.byr.learning.distributedlock.DistributedLock;
import com.byr.learning.distributedlock.readwrite.ReadWriteLock;
import com.byr.learning.distributedlock.unit.LockStatus;
...
public class ZKReadWriteLock1 implements ReadWriteLock {
    ...
    public ZKReadWriteLock1() throws Exception {
        ...
        zooKeeper = new ZooKeeper("10.3.0.82:3888", 1000, watcher);
